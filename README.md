...
<td align="center" width="50%">
  ...
  <sub>Open any photo for place, date, full EXIF (camera, lens, exposure) and a map — plus detected scene tags, face count, screenshot badge, **text in the photo (OCR)** and (for favorites) an AI description, all generated on device. Share to other apps from full screen; view and share counts are recorded too.</sub>
</td>
</tr>
<tr>
<td align="center" width="50%">
